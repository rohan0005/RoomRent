...
class PaymentHistory(models.Model):
    ...
    electricityPreviousUnit = models.IntegerField(default=0, blank=False)
    electricityCurrentUnit = models.IntegerField(default=0, blank=False) 
    electricityUnit = models.IntegerField(default=0, blank=False) 
    electricityAmount = models.IntegerField(default=0, blank=False) 
    waterCharge = models.IntegerField(default=0, blank=False) 
    TrashCharge = models.IntegerField(default=0, blank=False) 
    wasChargedLateFee = models.BooleanField(default=False)